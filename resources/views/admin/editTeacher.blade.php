                    ...
                    <div class="col-md-12">
                        <form method="POST" action="/teachers/{{$teacher->id}} ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="frist_name" name="frist_name" placeholder="frist_name Name" class="form-control here"
                                        type="text" value="{{$teacher->frist_name}}" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="last_name" name="last_name" placeholder="Last Name" class="form-control here"
                                        type="text" value="{{$teacher->last_name}}" />
                                    <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="email" name="email" placeholder="enter email" class="form-control here"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="mobile" name="mobile" placeholder="Mobile" class="form-control here"
                                        type="number" value="{{$teacher->mobile}}" />
                                    <div class="valid-feedback">Looks good!</div>
                                    <div class="invalid-feedback">
